...
# os.system('python train.py --dataroot /home/solanliu/yeyuntong/RainCycleGAN_dataset/middle_cityRH --dataset_mode rain --model unetderain --batch_size 8 --gpu_ids 0,1,2,3 --lr 0.0001 --name middle_UnetDerain')
